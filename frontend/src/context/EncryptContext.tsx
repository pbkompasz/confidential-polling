...
export const EncryptContext = createContext<EncryptContextType | undefined>(
  undefined,
);

const AUTHORIZED_CHAIN_ID = ['0xaa36a7', '0x2328'];

export const EncryptProvider = ({ children }: { children: any }) => {
  ...
  return (
    <EncryptContext.Provider value={{
      ...
      loading,
      account
    }}>{children}</EncryptContext.Provider>
  );
};
